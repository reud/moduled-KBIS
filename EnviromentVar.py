...
KBIS_MAXGEN=int(os.environ['KBIS_MAXGEN'] ) # 22
...
YEAR_BUDGET_START_COLUMN=3 # 3
YEAR_BUDGET_START_ROW=9

CORRECTION_BUDGET_START_COLUMN=5
CORRECTION_BUDGET_START_ROW=9

USEAMOUNT_START_COLUMN=10
USEAMOUNT_START_ROW=9
